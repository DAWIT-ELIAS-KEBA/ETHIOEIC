    ...
    <div class="container-lg">
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="my-5 d-flex justify-content-center">  <img src="logo.jpg" alt="logo"
                            class="desktop-logo"> <img src="logo.jpg" alt="logo" class="desktop-dark"> </a>
                </div>


<form action="{{ route('register') }}"  enctype="multipart/form-data" method="POST" id="login-form" class="white-popup-block">
                    @csrf
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <input type="email" class="form-control form-control-lg text-default" name="email"
                                        :value="old('email')" required autocomplete="username" placeholder="Email">
                                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                </div>
                                <div class="col-xl-12">

<input type="number" class="form-control form-control-lg text-default" name="phone"
    :value="old('nunmber')" required autocomplete="phone" placeholder="Phone">
<x-input-error :messages="$errors->get('email')" class="mt-2" />
</div>
...
function toggleInput() {
  ...
  if (selectedOption === "none") {
    ...
    document.getElementById("inputField").required = false;
    ...
    document.getElementById("inputField2").required = true;
...
<div class="col-xl-12"  id="inputContainer" style="display: none;">
...
<div class="input-group mb-3"> <input type="file" name="photo" class="form-control" required
                                                id="inputGroupFile02"> <label class="input-group-text"
                                                for="inputGroupFile02">Image</label> </div>
                                ...
                                <div class="col-xl-12 mb-2">
                                    ...
                                    <div class="form-check mt-3"> <input class="form-check-input" type="checkbox"
                                            ...
                                            class="form-check-label text-muted fw-normal" for="defaultCheck1"> By
                                            creating a account you agree to our <a href="terms_conditions"
        ...
        <div class="text-center">
            <p class="fs-12 text-muted mt-3">Already have an account? <a href="login1" class="text-primary">Sign In</a>
            </p>
        </div>
