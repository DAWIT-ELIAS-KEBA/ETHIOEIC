...
class Investment extends Model
{
    ...
    protected $id='id';
    protected $fillable = ['investment_type_id','company_name_id','company_name_status','trade_name','business_type_id',
                            'manager_id','created_by','attorney_name','reviewed_by','review_status','approved_by','approve_status',
